...
app.directive('dropZone',['$window', '$timeout', '$q', '$rootScope',
...
//						  }
				  ...
				  , defaultOptions = {
					  ...
					  dictFileTooBig:"File is too big ({{filesize}}MB). Max filesize: {{maxFilesize}}MiB. ",
					  dictInvalidFileType:"You can't upload files of this type.",
					  dictResponseError:"Server responded with {{statusCode}} code.",
					  dictCancelUpload:"删除",
					  dictCancelUploadConfirmation:"Are you sure you want to cancel this upload?",
					  dictRemoveFile:"删除",
					  dictRemoveFileConfirmation:"请确认删除？",
					  ...
					  previewRemoveTemplate:"<a class=\"dz-remove\" href=\"javascript:undefined;\">删除 </a>",
			  ...
			  function setupEventListeners () {
				  element.bind ( 'dragstart dragenter dragover dragleave drop dragend click', function( event ) {
					  switch( event.type )
					  {
						  case "dragstart":
							  break;
