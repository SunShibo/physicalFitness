'use strict';
app.controller('ServiceManyPicUploadCtrl',  ['$scope', 'FileUploader','$stateParams',   function($scope, FileUploader,$stateParams) {
   ...
   //第一张图片
	var uploader1 = $scope.uploader1 = new FileUploader({
		url: '/api/common/service_upload_inst_file?courseCode='+$stateParams.courseCode+"&instCode="+$stateParams.instCode+"&isType=1",
        autoUpload : true
    });
