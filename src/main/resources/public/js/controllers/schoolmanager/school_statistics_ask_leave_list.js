// 开启严格模式
'use strict';
app.controller('SchoolStatisticsAskLeaveListPageCtrl', ['$scope', '$http', '$state', '$stateParams',//这里引入学期Service可以调用他的方法
	...
	$scope.itemNames = [{name: "年级"},{name: "班级"},{name: "姓名"},{name: "性别"},{name: "教育ID"},{name: "课程名称"},{name: "上课时间"},{name: "授课老师"}];//列表页的表头
	 ...
	 $scope.init = function(/*pageable*/){//获取列表数据的方法
	    	...
	    	var requestUrl = "/api/schoolstatisticsmanager/school_statistics_ask_leave_list";
	    	$http({
				method  : 'POST',
				url     : requestUrl,
