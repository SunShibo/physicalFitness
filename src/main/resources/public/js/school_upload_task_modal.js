// 开启严格模式
'use strict';
app.controller('SchoolUploadTaskModalPageCtrl', ['$scope', 'FileUploader','$http', '$state','$uibModalInstance','$uibModal',//这里引入学期Service可以调用他的方法
    	...
    	if($scope.fileUploadResult.fileUri==null||$scope.fileUploadResult.fileUri==""){
    		...
    		if($scope.photoObj.type=="A"){
    		  ...
    		  var formData = {//声明用于传到后台的参数
    	    	...
    	    	var requestUrl = "/api/instteachercoursemanager/schooltteacher_add_taskphotos";
