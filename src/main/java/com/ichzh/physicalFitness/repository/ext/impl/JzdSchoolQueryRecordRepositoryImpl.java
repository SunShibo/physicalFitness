...
public class JzdSchoolQueryRecordRepositoryImpl extends BaseRepositoryExtImpl implements IJzdSchoolQueryRecordRepositoryExt {
	...
	public List<JzdSchoolQueryRecord> queryByMemberIdAndRecordTime(String memberId, Date recordTime) {
		...
		ISqlElement sqlElement = this.processSql(params, "JzdSchoolQueryRecordRepositoryImpl.queryByMemberIdAndRecordTime");
		return this.jdbcTemplate.query(sqlElement.getSql(), sqlElement.getParams(), new BeanPropertyRowMapper<>(JzdSchoolQueryRecord.class));
	}
